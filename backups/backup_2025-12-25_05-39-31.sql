...
CREATE TABLE admin_users (id INTEGER PRIMARY KEY AUTOINCREMENT, username VARCHAR(100) NOT NULL UNIQUE, password TEXT NOT NULL, full_name VARCHAR(100) NOT NULL, role VARCHAR(50) DEFAULT 'teacher', created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP);

-- Data for table: admin_users
INSERT INTO admin_users (id, username, password, full_name, role, created_at) VALUES ('2', 'ADMIN001', 'y2', 'ADMIN001', 'teacher', '2025-12-13 09:03:36');
INSERT INTO admin_users (id, username, password, full_name, role, created_at) VALUES ('5', 'admin', '$2y$12$vfnudERq57k0pNksMlR8h.KcRb5aYQh3zaUmNNvz5zCkElJSrJMly', 'Administrator', 'admin', '2025-12-13 19:50:09');
...
CREATE TABLE user_permissions (
        ...
        created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
        FOREIGN KEY (user_id) REFERENCES "admin_users_old"(id) ON DELETE CASCADE
    );
...
CREATE TABLE teacher_subjects (
        ...
        created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
        FOREIGN KEY (teacher_id) REFERENCES "admin_users_old"(id) ON DELETE CASCADE,
